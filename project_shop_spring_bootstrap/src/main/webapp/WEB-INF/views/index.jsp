        ...
        <c:forEach items="${productList}" var="product" varStatus="status" step="3">
          ...
          <div class="col-md-4 col-sm-6">
            <div class="card mb-30">
            	<a class="card-img-tiles" href="shop-grid-ns">
	                <div class="inner">
          ...
          <div class="grid-item">
            <div class="product-card">
              ...
              <div class="product-buttons">
                ...
                <button class="btn btn-outline-primary btn-sm btn-add-cart" p-no="${product.p_no}" data-toast data-toast-type="success" data-toast-position="topCenter" data-toast-icon="icon-circle-check" data-toast-title="${product.p_name}" data-toast-message="successfuly added to cart!">Add to Cart</button>
              </div>
            </div>
          </div>
        <!-- Product end-->
