      ...
      <div class="container padding-bottom-3x mb-2">
        <div class="card text-center">
          <div class="card-body padding-top-2x">
            ...
            <div class="padding-top-1x padding-bottom-1x"><a class="btn btn-outline-secondary" href="shop-grid-ns">Go Back Shopping</a><a class="btn btn-outline-primary" href="account-orders"><i class="icon-location"></i>&nbsp;Order list</a></div>
          </div>
        </div>
      </div>
      <!-- Site Footer-->
